...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = from emp in Emps where emp.Job.Equals("Backend programmer") select emp ;
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = (from emp in Emps where emp.Job.Equals("Frontend programmer") && emp.Salary>1000 select emp).OrderBy(emp => emp.Ename);
            return result;
        }
        ...
        {
            bool result = (from emp in Emps where emp.Job.Equals("Backend programmer") select emp).ToList().Count>0;
            return result;
        }
        ...
        {
            Emp result = (from emp in Emps where emp.Job.Equals("Frontend programmer") select emp)
        ...
        {
            var data = new[] { new { v = "x" } };
            IEnumerable<object> nulle = from n in data select new { Ename = "Brak wartości",Job = (string)null,HireDate =(string)null};
            IEnumerable<object> result = (from emp in Emps select new {emp.Ename,emp.Job,emp.HireDate}).Union(nulle);
            return result;
        }
        ...
        public static IEnumerable<object> Task11()
        {
            IEnumerable<object> result = from dept in Depts
                ...
                into GroupedDept
                where GroupedDept.Count() > 1
                select new { name = GroupedDept.Key, numOfEmployees = GroupedDept.Count() };
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = CustomExtensionMethods.GetEmpByMgr(Emps).ToList();
            return result;
        }
        ...
        {
            int result = 0;
            result = (from l in arr
                group l by l
                into GroupedInt
                where GroupedInt.Count() % 2 != 0
                select GroupedInt.Count()).FirstOrDefault();
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            ...
            var Dept_names = from emp in Emps join dept in Depts on emp.Deptno equals dept.Deptno
                group dept by dept.Dname
                into GroupedDetp
                where GroupedDetp.Count() == 5 || GroupedDetp.Count() == 0
                select GroupedDetp.Key;
            result = from dept in Depts where Enumerable.Contains<String>(Dept_names,dept.Dname) select dept;
            return result;
        }
    }
    ...
    public static class CustomExtensionMethods
    {
        ...
        public static IEnumerable<Emp> GetEmpByMgr(this IEnumerable<Emp> Emp)
        {
            var result =  Emp.Where(emp => Emp.Any(e => e.Mgr != null && e.Mgr.Empno == emp.Empno))
